...
console.log("At index 1:", linkedList.at(4));  // Node 1

// 5. Search Tests
console.log("\n--- Search Tests ---");
console.log("Contains 'Node 3':", linkedList.contains("Node 3")); // true
console.log("Contains 'Ghost':", linkedList.contains("Ghost"));   // false
console.log("Index of 'Node 3':", linkedList.findIndex("Node 3")); // 2
